...
if __name__ == "__main__":
    ...
    #transfer = openmc.deplete.transfer_rates.TransferRates(op, model)
    integrator.add_transfer_rate('f', transfer_elements, rate,
                                destination_material=dest_mat)
    t = integrator.transfer_rates.index_transfer
    for s in t:
        break
    integrator.transfer_rates.index_transfer = s
    print(integrator.transfer_rates.index_transfer)
