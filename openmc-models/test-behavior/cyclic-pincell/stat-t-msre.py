...
if run:
    if multi_region:
        integrator.add_transfer_rate(fuelsalt.name, elements, lambda_in, destination_material=excore.name)
        integrator.add_transfer_rate(excore.name, elements, lambda_out, destination_material=fuelsalt.name)
