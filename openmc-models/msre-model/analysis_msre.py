...
if __name__ == '__main__':
    ...
    depletion = True
    depletion_steps = 20
    summary_path = './msre-results/1-msre-none'
    run_single = False
    run_multi = True
