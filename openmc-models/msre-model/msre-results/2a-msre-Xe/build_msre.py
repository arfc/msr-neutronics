...
if __name__ == '__main__':
    ...
    # t = 5, 10, 40, 70, 100, 280, and 375 days
    #reaction_rates = [10, 100, 280, 375]
    #flux_calcs = [5, 40, 70]
    time_steps_a = [1/8, 1/8, 1/4, 1/4, 1/4, 1, 1, 1, 1, 1, 1, 1]
    d_per_a = 365.25
    use_steps = [i*d_per_a for i in time_steps_a]
    time_steps_d = [(use_steps[:5], True),
                    (use_steps[5:], False)]
    ...
    deplete = True
    plotting = False
    # Number fuel materials
    fuel_subdivisions = 1
    positive_flow_dir = True
    n = 8
    s = 5
    # -n is number processes
    # -s is number threads
    ...
    model.full_run(batches, inactive, particles, deplete, data_directory,
