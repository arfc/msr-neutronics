...
DATE                      (idx, [1: 24]) = 'Fri Oct 21 13:17:57 2016' ;
...
DT_EFF                    (idx, 1)       = 8.64915E-01 ;
MIN_MACROXS               (idx, 1)       = 1.16215E-01 ;

% Run statistics:

RUNNING_TIME              (idx, 1)       = 2.66665E+00 ;
INIT_TIME                 (idx, 1)       = 2.30367E-01 ;
TRANSPORT_CYCLE_TIME      (idx, 1)       = 2.43532E+00 ;
BURNUP_CYCLE_TIME         (idx, 1)       = 0.00000E+00 ;
PROCESS_TIME              (idx, 1)       = 9.66664E-04 ;
CYCLE_IDX                 (idx, 1)       = 500 ;
...
COLLISIONS                (idx, 1)        = 26566885 ;
FISSION_FRACTION          (idx, 1)        = 3.91661E-03 ;
CAPTURE_FRACTION          (idx, 1)        = 1.33527E-03 ;
ELASTIC_FRACTION          (idx, 1)        = 6.78291E-01 ;
INELASTIC_FRACTION        (idx, 1)        = 7.46678E-03 ;
ALPHA_FRACTION            (idx, 1)        = 0.00000E+00 ;
BOUND_SCATTERING_FRACTION (idx, 1)        = 3.08990E-01 ;
NXN_FRACTION              (idx, 1)        = 1.88204E-07 ;
UNKNOWN_FRACTION          (idx, 1)        = 0.00000E+00 ;
VIRTUAL_FRACTION          (idx, 1)        = 1.35085E-01 ;

FREEGAS_FRACTION          (idx, 1)        = 2.36356E-01 ;
TOTAL_ELASTIC_FRACTION    (idx, 1)        = 9.87281E-01 ;
FISSILE_FISSION_FRACTION  (idx, 1)        = 9.99981E-01 ;
LEAKAGE_REACTIONS         (idx, 1)        = 110479 ;

REA_SAMPLING_EFF          (idx, 1)        = 6.37120E-01 ;

% Slowing-down and thermalization:

COL_SLOW                  (idx, [1:   2]) = [  9.48295E+01 0.00013 ];
COL_THERM                 (idx, [1:   2]) = [  5.98255E+01 0.00132 ];
COL_TOT                   (idx, [1:   2]) = [  1.38638E+02 0.00058 ];
SLOW_TIME                 (idx, [1:   2]) = [  3.29742E-05 0.00040 ];
THERM_TIME                (idx, [1:   2]) = [  3.39790E-04 0.00148 ];
SLOW_DIST                 (idx, [1:   2]) = [  3.45209E+01 0.00061 ];
THERM_DIST                (idx, [1:   2]) = [  2.27532E+01 0.00093 ];
THERM_FRAC                (idx, [1:   2]) = [  5.74817E-01 0.00098 ];
...
ENTROPY_X                 (idx, [1:   2]) = [  9.02346E-01 0.00043 ];
ENTROPY_Y                 (idx, [1:   2]) = [  9.01585E-01 0.00042 ];
ENTROPY_Z                 (idx, [1:   2]) = [  9.40391E-01 0.00034 ];
ENTROPY_TOT               (idx, [1:   2]) = [  7.29442E-01 0.00025 ];

% Fission source centre:

SOURCE_X0                 (idx, [1:   2]) = [  2.12064E-03 23.70671 ];
SOURCE_Y0                 (idx, [1:   2]) = [  1.02597E-01 0.47987 ];
SOURCE_Z0                 (idx, [1:   2]) = [  8.13778E+01 0.00087 ];

% Criticality eigenvalues:

ANA_KEFF                  (idx, [1:   2]) = [  1.01573E+00 0.00134 ];
IMP_KEFF                  (idx, [1:   2]) = [  1.01585E+00 0.00108 ];
COL_KEFF                  (idx, [1:   2]) = [  1.01799E+00 0.00149 ];
ABS_KEFF                  (idx, [1:   2]) = [  1.01585E+00 0.00108 ];
ABS_KINF                  (idx, [1:   2]) = [  1.81707E+00 0.00010 ];
ABS_GC_KEFF               (idx, [1:   2]) = [  1.85603E+00 0.00010 ];
ABS_GC_KINF               (idx, [1:   2]) = [  1.85603E+00 0.00010 ];
IMPL_ALPHA_EIG            (idx, [1:   2]) = [  2.14807E+02 0.08117 ];
FIXED_ALPHA_EIG           (idx, [1:   2]) = [  0.00000E+00 0.00000 ];
GEOM_ALBEDO               (idx, [1:   2]) = [  1.00000E+00 0.00000 ];

% Normalized total reaction rates:

TOT_POWER                 (idx, [1:   2]) = [  1.35129E-11 0.00108 ];
TOT_GENRATE               (idx, [1:   2]) = [  1.01583E+00 0.00108 ];
TOT_FISSRATE              (idx, [1:   2]) = [  4.16971E-01 0.00108 ];
TOT_ABSRATE               (idx, [1:   2]) = [  5.59006E-01 0.00102 ];
TOT_LEAKRATE              (idx, [1:   2]) = [  4.40994E-01 0.00129 ];
TOT_LOSSRATE              (idx, [1:   2]) = [  1.00000E+00 0.00000 ];
TOT_FLUX                  (idx, [1:   2]) = [  2.91374E+02 0.00074 ];
TOT_RR                    (idx, [1:   2]) = [  1.06308E+02 0.00075 ];
TOT_SOLU_ABSRATE          (idx, [1:   2]) = [  0.00000E+00 0.00000 ];


% Point-kinetic parameters:

ANA_PROMPT_LIFETIME       (idx, [1:   2]) = [  3.08511E-04 0.00143 ];
IMPL_PROMPT_LIFETIME      (idx, [1:   2]) = [  6.26580E-05 0.00110 ];
ANA_REPROD_TIME           (idx, [1:   2]) = [  3.04823E-04 0.00197 ];
IMPL_REPROD_TIME          (idx, [1:   2]) = [  6.16776E-05 0.00010 ];
DELAYED_EMTIME            (idx, [1:   2]) = [  1.26324E+01 0.02933 ];

% Six-factor formula:

SIX_FF_ETA                (idx, [1:   2]) = [  1.97585E+00 0.00072 ];
SIX_FF_F                  (idx, [1:   2]) = [  9.79471E-01 0.00022 ];
SIX_FF_P                  (idx, [1:   2]) = [  8.22699E-01 0.00062 ];
SIX_FF_EPSILON            (idx, [1:   2]) = [  1.14316E+00 0.00060 ];
SIX_FF_LF                 (idx, [1:   2]) = [  6.72368E-01 0.00083 ];
SIX_FF_LT                 (idx, [1:   2]) = [  8.30667E-01 0.00054 ];
SIX_FF_KINF               (idx, [1:   2]) = [  1.81890E+00 0.00081 ];
SIX_FF_KEFF               (idx, [1:   2]) = [  1.01594E+00 0.00130 ];

% Delayed neutron parameters:

PRECURSOR_GROUPS          (idx, 1)        = 8 ;
BETA_EFF                  (idx, [1:  18]) = [  7.11604E-03 0.01999  2.38343E-04 0.11106  1.13707E-03 0.05203  6.55450E-04 0.06369  1.49812E-03 0.04395  2.13208E-03 0.03571  7.02324E-04 0.06808  5.57365E-04 0.07106  1.95285E-04 0.11234 ];
BETA_ZERO                 (idx, [1:  18]) = [  6.64998E-03 0.00001  2.10577E-04 0.00472  9.74324E-04 0.00471  5.93277E-04 0.00473  1.25847E-03 0.00471  2.07867E-03 0.00472  5.78975E-04 0.00471  5.25667E-04 0.00472  1.47410E-04 0.00472 ];
DECAY_CONSTANT            (idx, [1:  18]) = [  4.10575E-01 0.02949  1.24667E-02 0.00000  2.82917E-02 0.00000  4.25244E-02 0.00000  1.33042E-01 0.00000  2.92467E-01 0.00000  6.66488E-01 0.00000  1.63478E+00 0.00000  3.55460E+00 0.00000 ];
...
FLUX                      (idx, [1:   6]) = [  8.91759E+01 0.00075  6.37828E+01 0.00090  2.53931E+01 0.00115 ];
LEAK                      (idx, [1:   6]) = [  0.00000E+00 0.00000  0.00000E+00 0.00000  0.00000E+00 0.00000 ];
TOTXS                     (idx, [1:   6]) = [  2.61127E-01 0.00006  2.60304E-01 0.00008  2.63192E-01 0.00005 ];
FISSXS                    (idx, [1:   6]) = [  4.67715E-03 0.00094  8.18277E-04 0.00064  1.43652E-02 0.00036 ];
CAPTXS                    (idx, [1:   6]) = [  1.46146E-03 0.00065  7.05301E-04 0.00076  3.35987E-03 0.00032 ];
ABSXS                     (idx, [1:   6]) = [  6.13862E-03 0.00086  1.52358E-03 0.00060  1.77250E-02 0.00036 ];
ELAXS                     (idx, [1:   6]) = [  2.46203E-01 0.00006  2.46496E-01 0.00008  2.45467E-01 0.00003 ];
INELAXS                   (idx, [1:   6]) = [  8.78608E-03 0.00084  1.22841E-02 0.00068  2.06942E-17 0.41785 ];
SCATTXS                   (idx, [1:   6]) = [  2.54989E-01 0.00006  2.58780E-01 0.00008  2.45467E-01 0.00003 ];
N2NXS                     (idx, [1:   6]) = [  1.85980E-07 0.03083  2.59774E-07 0.03077  0.00000E+00 0.00000 ];
REMXS                     (idx, [1:   6]) = [  6.13862E-03 0.00086  3.46171E-03 0.00159  1.91705E-02 0.00048 ];
NUBAR                     (idx, [1:   6]) = [  2.43622E+00 0.00000  2.43637E+00 0.00000  2.43620E+00 0.00000 ];
NSF                       (idx, [1:   6]) = [  1.13946E-02 0.00094  1.99362E-03 0.00064  3.49964E-02 0.00036 ];
RECIPVEL                  (idx, [1:   6]) = [  7.02814E-07 0.00096  1.02013E-07 0.00073  2.21120E-06 0.00032 ];
...
GTRANSFP                  (idx, [1:   8]) = [  9.92511E-01 0.00002  5.88899E-03 0.00556  7.48878E-03 0.00275  9.94111E-01 0.00003 ];
GTRANSFXS                 (idx, [1:   8]) = [  2.56842E-01 0.00008  1.44549E-03 0.00556  1.93787E-03 0.00275  2.44021E-01 0.00005 ];

% Diffusion parameters:

DIFFAREA                  (idx, [1:   6]) = [  2.99158E+02 0.00123  1.44444E+02 0.00152  8.68604E+01 0.00474 ];
DIFFCOEF                  (idx, [1:   6]) = [  1.83709E+00 0.00162  5.00120E-01 0.00226  1.66362E+00 0.00466 ];
TRANSPXS                  (idx, [1:   6]) = [  1.82401E-01 0.00163  6.73252E-01 0.00224  2.09482E-01 0.00486 ];
MUBAR                     (idx, [1:   6]) = [  3.08754E-01 0.00380 -1.59571E+00 0.00365  2.18766E-01 0.01901 ];

% Material buckling:

MAT_BUCKLING              (idx, [1:   2]) = [  2.86989E-03 0.00121 ];
...
RUNNING_TIME              (idx, 1)       = 2.66668E+00 ;
INIT_TIME                 (idx, 1)       = 2.30367E-01 ;
TRANSPORT_CYCLE_TIME      (idx, 1)       = 2.43535E+00 ;
BURNUP_CYCLE_TIME         (idx, 1)       = 0.00000E+00 ;
PROCESS_TIME              (idx, 1)       = 9.66664E-04 ;
CYCLE_IDX                 (idx, 1)       = 500 ;
SOURCE_NEUTRONS           (idx, 1)       = 1000000 ;
...
FLUX                      (idx, [1:   6]) = [  2.02198E+02 0.00075  1.42790E+02 0.00087  5.94076E+01 0.00117 ];
LEAK                      (idx, [1:   6]) = [  0.00000E+00 0.00000  0.00000E+00 0.00000  0.00000E+00 0.00000 ];
TOTXS                     (idx, [1:   6]) = [  4.10588E-01 0.00007  3.95526E-01 0.00008  4.46789E-01 0.00002 ];
FISSXS                    (idx, [1:   6]) = [  9.89168E-43 0.00073  1.40066E-42 0.00055  3.37578E-42 0.00157 ];
CAPTXS                    (idx, [1:   6]) = [  5.80337E-05 0.00158  1.50203E-05 0.00740  1.61361E-04 0.00034 ];
ABSXS                     (idx, [1:   6]) = [  5.80337E-05 0.00158  1.50203E-05 0.00740  1.61361E-04 0.00034 ];
ELAXS                     (idx, [1:   6]) = [  4.10477E-01 0.00007  3.95437E-01 0.00008  4.46627E-01 0.00002 ];
INELAXS                   (idx, [1:   6]) = [  5.26746E-05 0.00651  7.45842E-05 0.00649  8.72589E-17 0.58533 ];
SCATTXS                   (idx, [1:   6]) = [  4.10530E-01 0.00007  3.95511E-01 0.00008  4.46627E-01 0.00002 ];
N2NXS                     (idx, [1:   6]) = [  0.00000E+00 0.00000  0.00000E+00 0.00000  0.00000E+00 0.00000 ];
REMXS                     (idx, [1:   6]) = [  5.80337E-05 0.00158  3.84634E-03 0.00097  1.19222E-03 0.00381 ];
...
RECIPVEL                  (idx, [1:   6]) = [  7.32114E-07 0.00098  1.04198E-07 0.00052  2.24063E-06 0.00034 ];
...
GTRANSFP                  (idx, [1:   8]) = [  9.90313E-01 0.00001  2.30813E-03 0.00441  9.68665E-03 0.00095  9.97692E-01 0.00001 ];
GTRANSFXS                 (idx, [1:   8]) = [  3.91680E-01 0.00008  1.03086E-03 0.00441  3.83132E-03 0.00097  4.45596E-01 0.00002 ];

% Diffusion parameters:

DIFFAREA                  (idx, [1:   6]) = [  2.89855E+02 0.00991  2.05007E+02 0.00139  2.43458E+01 0.01161 ];
DIFFCOEF                  (idx, [1:   6]) = [  1.67810E-02 0.00996  7.88102E-01 0.00152  2.84676E-02 0.01118 ];
TRANSPXS                  (idx, [1:   6]) = [  3.46091E+01 0.11734  4.24936E-01 0.00154  1.49850E+01 0.01248 ];
MUBAR                     (idx, [1:   6]) = [ -8.33510E+01 0.11905 -7.44012E-02 0.02233 -3.25512E+01 0.01286 ];

% Material buckling:

MAT_BUCKLING              (idx, [1:   2]) = [ -5.97934E-03 0.11503 ];
...
SCATT0                    (idx, [1:   6]) = [  4.10533E-01 0.00007  3.95516E-01 0.00008  4.46626E-01 0.00002 ];
SCATT1                    (idx, [1:   6]) = [  2.28580E-02 0.00112  2.65260E-02 0.00113  1.40431E-02 0.00345 ];
SCATT2                    (idx, [1:   6]) = [  4.75186E-04 0.04209  2.36732E-03 0.00990 -4.06909E-03 0.00952 ];
SCATT3                    (idx, [1:   6]) = [ -9.44902E-04 0.01700  3.44108E-04 0.05557 -4.04620E-03 0.00787 ];
SCATT4                    (idx, [1:   6]) = [ -1.80947E-03 0.00811 -3.55297E-04 0.04960 -5.30547E-03 0.00519 ];
SCATT5                    (idx, [1:   6]) = [ -9.93685E-04 0.01357  1.27294E-04 0.12738 -3.68781E-03 0.00698 ];

% P1 diffusion parameters:

P1_TRANSPXS               (idx, [1:   6]) = [  3.87730E-01 0.00011  3.69000E-01 0.00012  4.32745E-01 0.00012 ];
P1_DIFFCOEF               (idx, [1:   6]) = [  8.59725E-01 0.00011  9.03369E-01 0.00012  7.70296E-01 0.00012 ];
P1_MUBAR                  (idx, [1:   6]) = [  5.56808E-02 0.00113  6.70682E-02 0.00114  3.14431E-02 0.00346 ];
