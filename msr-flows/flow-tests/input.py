...
if NON_CYCLE:
    # Hopefully if the Serpent bug is fixed for cyclical flows, this can be used alone
    NON_CYCLE_INP_NAME = str(INPUT_NAME) + '_non_cycle'
    NON_CYCLE_OUT_NAME = str(OUTPUT_NAME) + '_non_cycle'
    non_cycle_input_script = sb.make_input(NON_CYCLE_INP_NAME, CYCLE_TIME_SECONDS, CYCLE_STEP_SIZE_SECONDS, NUM_CYCLES)
...
if MULTI_CORE:
    ...
    multi_input_script = csb.make_input(MULTI_INP_NAME, CYCLE_TIME_SECONDS, CYCLE_STEP_SIZE_SECONDS, NUM_CYCLES)
